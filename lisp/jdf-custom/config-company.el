;;; $DOOMDIR/lisp/jdf-custom/config-company.el -*- lexical-binding: t; -*-
...
(use-package! company
  ...
  :bind (;; Replace `completion-at-point' and `complete-symbol' with
         ...
         ("SPC" . nil) ([space] . nil)
         ("ESC" . nil) ([escape] . nil)
         ("ESC" . company-abort) ([escape] . company-abort)
  ...
  (setq company-idle-delay (lambda () (if (company-in-string-or-comment) nil 0.25)))
